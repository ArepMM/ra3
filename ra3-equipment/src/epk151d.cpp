...
//
//------------------------------------------------------------------------------
AutoTrainStopEPK151D::AutoTrainStopEPK151D(QObject *parent)
...
//
//------------------------------------------------------------------------------
AutoTrainStopEPK151D::~AutoTrainStopEPK151D()
{
...
//
//------------------------------------------------------------------------------
double AutoTrainStopEPK151D::getEmergencyBrakeRate() const
{
...
//
//------------------------------------------------------------------------------
void AutoTrainStopEPK151D::init(double pTM, double pFL)
{
    setY(0, 0.0);
    setY(2, pTM);
    setY(1, pFL);
...
//
//------------------------------------------------------------------------------
void AutoTrainStopEPK151D::ode_system(const state_vector_t &Y,
                                     state_vector_t &dYdt,
                                     double t)
{
    Q_UNUSED(t)
...
//
//------------------------------------------------------------------------------
void AutoTrainStopEPK151D::preStep(state_vector_t &Y, double t)
{
    Q_UNUSED(Y)
    Q_UNUSED(t)
...
//
//------------------------------------------------------------------------------
void AutoTrainStopEPK151D::load_config(CfgReader &cfg)
{
...
//
//------------------------------------------------------------------------------
void AutoTrainStopEPK151D::stepKeysControl(double t, double dt)
{
    Q_UNUSED(t)
    Q_UNUSED(dt)
